        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                    <h3 class="px-6 py-3 border-b border-gray-200 bg-gray-700 text-center text-3xl leading-4 font-medium text-white uppercase tracking-wider sm:rounded-lg">Create New Invoice</h3>
                            ...
                            <div class="flex justify-center items-center w-full">
                                <div class="w-1/2 bg-gray-700 sm:rounded-lg shadow-2xl p-8 m-4">
                                    ...
                                    <form action="/" method="post">
                                        ...
                                        <div class="flex flex-col mb-4">
                                            <label class="mb-2 font-bold text-lg text-white" for="Select">Contact person regarding the invoice</label>
                                            <select class="border py-2 px-3 text-grey-800">
                                        ...
                                        <div class="col-span-2 text-right">
                                            <button class="py-3 px-6 bg-green-500 text-white font-bold w-full sm:w-32 hover:bg-green-600 sm:rounded-lg">
                                              Submit
                                            </button>
                                          </div>
                                    </form>
